...
import (
	...
	"github.com/titantkx/ethermint/server"
...
func startInProcess(cfg Config, val *Validator) error {
	...
	if val.AppConfig.JSONRPC.Enable && val.AppConfig.JSONRPC.Address != "" {
		...
		val.jsonrpc, val.jsonrpcDone, err = server.StartJSONRPC(val.Ctx, val.ClientCtx, val.RPCClient, tmRPCAddr, tmEndpoint, val.AppConfig, nil)
		if err != nil {
			return err
		}
